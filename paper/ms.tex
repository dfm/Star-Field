...
\begin{abstract}
We present a probabilistic (Bayesian) method for producing catalogs
...
broken power-law. We compare the results obtained from our method
with those obtained from the popular \sex~software and find that our method
... . We conclude that the inferences from our method are more reliable,
especially in the case where the field is crowded with many overlapping stars.
\end{abstract}
...
is potentially very lossy; the hard decisions of catalog making destroy
...
propagated into any inferences about the stellar population.
...
the parameters and the data, otherwise new data tells you about nothing but
itself.
...
because the efficiency of Nested Sampling methods is sensitive to the ``information'',
or the amount of prior mass occupied by the posterior distribution. In this case,
because of the large number of parameters, the information is very large, about
3000 nats.
