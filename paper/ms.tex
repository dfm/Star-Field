...
We now apply the method to two illustrative simulated images. Each of the images
is $100 \times 100$ pixels in extent. The first image contains 100 stars and
the second image contains 1000 stars. These images are shown in
Figure~\ref{simulated_data}.
