...
\begin{eqnarray}
\ln s_1 &\sim& \textnormal{Uniform}(\ln(0.5L), \ln(50L)) \\
...
The PSF parameters $\{s_1, s_2, w\}$ and the noise parameters $\sigma_0$ and
$\eta$ were also inferred accurately with small uncertainties.
