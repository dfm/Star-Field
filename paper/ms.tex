...
\citep{dnest} method (hereafter DNS). DNS is based on the Metropolis-Hastings
algorithm and
...
difference between the two datasets is the number of stars.
\label{tab:truth}}
\end{table}
...
Test Case 1 was run with the DNS algorithm. 
