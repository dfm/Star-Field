...
x_2\left((1-F)\left(\frac{x_2}{x_1}\right)^{\alpha_1}\right)^{-\frac{1}{\alpha_2}}, & & 1 - \left(\frac{x_1}{x_2}\right)^{\alpha_1} \leq x \leq 1
\end{array}
\right.
\end{eqnarray}
...
\left[\alpha_2 x_1^{\alpha_1} x^{\alpha_2 - \alpha_1}\right]x^{-\alpha_2 - 1}, & & x > x_2
\end{array}
\right.
\end{eqnarray}
